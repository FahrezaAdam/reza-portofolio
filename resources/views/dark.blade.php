...
<div id="mobile-menu" class="hidden md:hidden bg-surface/95 dark:bg-inverse-surface/95 backdrop-blur-lg border-t border-outline-variant/20 px-gutter py-4 shadow-lg transition-all duration-300">
    <div class="flex flex-col space-y-3">
        ...
        <div class="pt-2 border-t border-outline-variant/20">
            <a class="bg-primary-container hover:brightness-110 text-on-primary-container font-label-md px-4 py-2.5 rounded-lg transition-transform active:scale-95 flex items-center justify-center gap-2 glow-hover w-full" href="{{ asset('CV_Fahreza_Adam_Nuardiansyah.pdf') }}" download>

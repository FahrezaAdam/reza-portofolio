...
<a class="font-display text-headline-md font-bold text-primary dark:text-primary-fixed hover:text-primary-container transition-colors" href="#">Fahreza Adam</a>
<div class="hidden md:flex items-center space-x-md">
<a class="text-primary dark:text-primary-fixed font-bold border-b-2 border-primary transition-all duration-300 ease-in-out py-1" href="#profile">Profile</a>
<a class="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors py-1" href="#education">Education</a>
<a class="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors py-1" href="#skills">Skills</a>
<a class="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors py-1" href="#projects">Projects</a>
<a class="text-on-surface-variant hover:text-primary transition-colors py-1" href="#contact">Contact</a>
<a class="text-on-surface-variant hover:text-primary transition-colors py-1 ml-2 flex items-center" href="?theme=dark" title="Switch to Dark Mode">
    <span class="material-symbols-outlined text-[20px]">dark_mode</span>
</a>
<a class="bg-primary hover:bg-primary-container text-on-primary font-label-md px-4 py-2 rounded-lg transition-transform hover:scale-105 active:scale-95 ml-4" href="#">Resume</a>
</div>
...
<a class="bg-primary text-on-primary font-label-md text-label-md px-6 py-3 rounded-lg hover:bg-primary-container transition-all hover:scale-105 flex items-center gap-2" href="#projects">
                        View Projects
                        <span class="material-symbols-outlined text-[18px]" data-icon="arrow_forward">arrow_forward</span>
</a>
<a class="bg-transparent border border-outline text-primary font-label-md text-label-md px-6 py-3 rounded-lg hover:bg-surface-container-low transition-colors flex items-center gap-2" href="#contact">
                        Contact Me
                    </a>
</div>
</div>
...
<h2 class="font-display text-headline-lg text-on-surface mb-12 text-center">Education &amp; Academics</h2>
<div class="bg-surface border border-outline-variant/30 rounded-xl p-8 max-w-3xl mx-auto card-hover ambient-shadow relative overflow-hidden">
...
<span class="bg-surface-container px-3 py-1.5 rounded text-sm text-on-surface-variant font-code-sm">Web &amp; Mobile Programming</span>
<span class="bg-surface-container px-3 py-1.5 rounded text-sm text-on-surface-variant font-code-sm">API Interface</span>
<span class="bg-surface-container px-3 py-1.5 rounded text-sm text-on-surface-variant font-code-sm">Database Systems</span>
<span class="bg-surface-container px-3 py-1.5 rounded text-sm text-on-surface-variant font-code-sm">SQL</span>
<span class="bg-surface-container px-3 py-1.5 rounded text-sm text-on-surface-variant font-code-sm">Software Analysis &amp; Design</span>
</div>
</div>
</div>
</section>
...
<h2 class="font-display text-headline-lg text-on-surface mb-12 text-center">Technical Arsenal</h2>
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
<!-- Languages -->
<div class="bg-surface border border-outline-variant/30 rounded-xl p-6 hover:border-primary/50 transition-colors bg-white">
...
<span class="bg-tertiary-fixed text-on-tertiary-fixed-variant font-label-md px-2.5 py-1 rounded">Python</span>
</div>
</div>
<!-- Frameworks -->
<div class="bg-surface border border-outline-variant/30 rounded-xl p-6 hover:border-primary/50 transition-colors bg-white">
...
<div class="flex flex-wrap gap-2">
<span class="bg-tertiary-fixed text-on-tertiary-fixed-variant font-label-md px-2.5 py-1 rounded">Git</span>
<span class="bg-tertiary-fixed text-on-tertiary-fixed-variant font-label-md px-2.5 py-1 rounded">REST API</span>
...
<!-- Project 1 (Large) -->
<div class="lg:col-span-8 bg-surface rounded-xl border border-outline-variant/30 overflow-hidden card-hover ambient-shadow flex flex-col md:flex-row bg-white">
...
<span class="bg-primary/10 text-primary font-label-md px-2 py-0.5 rounded text-xs">Cloud</span>
</div>
<h3 class="font-display text-headline-md text-on-surface mb-3">EarthCare</h3>
...
<div class="mt-auto">
<a class="inline-flex items-center gap-1 text-primary font-label-md hover:text-primary-container group" href="#">
...
<!-- Project 2 (Small) -->
<div class="lg:col-span-4 bg-surface rounded-xl border border-outline-variant/30 overflow-hidden card-hover ambient-shadow flex flex-col bg-white">
...
<div class="flex items-center gap-2 mb-3">
<span class="bg-secondary/10 text-secondary font-label-md px-2 py-0.5 rounded text-xs">IoT</span>
<span class="bg-secondary/10 text-secondary font-label-md px-2 py-0.5 rounded text-xs">Web</span>
</div>
<h3 class="font-display text-headline-md text-[20px] text-on-surface mb-2">AquaSync</h3>
...
<div class="lg:col-span-12 bg-surface rounded-xl border border-outline-variant/30 overflow-hidden card-hover ambient-shadow bg-white flex flex-col md:flex-row items-center p-6 gap-8">
<div class="w-16 h-16 bg-surface-container rounded-full flex items-center justify-center shrink-0">
...
<h3 class="font-display text-headline-md text-[20px] text-on-surface mb-2">Berbagi</h3>
...
<div class="lg:col-span-4 bg-surface rounded-xl border border-outline-variant/30 overflow-hidden card-hover ambient-shadow flex flex-col bg-white"><div class="h-48 bg-surface-container-low relative flex items-center justify-center"><span class="material-symbols-outlined text-primary/20 text-[48px]">add_circle</span></div><div class="p-6 flex-1 flex flex-col"><div class="flex items-center gap-2 mb-3"><span class="bg-secondary/10 text-secondary font-label-md px-2 py-0.5 rounded text-xs">Category</span><span class="bg-secondary/10 text-secondary font-label-md px-2 py-0.5 rounded text-xs">Tech</span></div><h3 class="font-display text-headline-md text-[20px] text-on-surface mb-2">New Project Title</h3><p class="font-body-md text-sm text-on-surface-variant mb-4">Brief description of the project, its core features, and the technical challenges solved during development.</p><div class="mt-auto"><a class="inline-flex items-center gap-1 text-primary font-label-md hover:text-primary-container group" href="#">View Details <span class="material-symbols-outlined text-[18px] group-hover:translate-x-1 transition-transform" data-icon="arrow_right_alt">arrow_right_alt</span></a></div></div></div></div>
</section>
<!-- Experience Section -->
<section class="bg-surface-container-lowest border-y border-outline-variant/20 py-xl">
<div class="max-w-container-max mx-auto px-gutter">
<h2 class="font-display text-headline-lg text-on-surface mb-10 text-center flex justify-center items-center gap-3">
...
<!-- Footer -->
<footer class="bg-surface-container dark:bg-surface-container-highest transition-opacity duration-200 full-width" id="contact">
...
<h2 class="font-display text-headline-md font-bold text-primary dark:text-primary-fixed mb-2">Let's Connect</h2>
<p class="text-on-surface-variant dark:text-surface-variant font-body-md text-sm">
...
<a class="flex items-center gap-2 text-on-surface-variant hover:text-primary transition-colors" href="https://www.linkedin.com/in/fahreza-adam-nuardiansyah/" target="_blank">
